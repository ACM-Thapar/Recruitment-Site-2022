        ...
        <div>
          <style
            ...
            dangerouslySetInnerHTML={{
              __html: '@media print{.form-section{display:inline!important}.form-pagebreak{display:none!important}.form-section-closed{height:auto!important}.page-section{position:initial!important}}',
            }}
          />
          <link
            type="text/css"
          ...
          <link
            type="text/css"
            rel="stylesheet"
            href="https://cdn02.jotfor.ms/css/styles/payment/payment_styles.css?3.3.34520"
          />
          <link
            type="text/css"
            rel="stylesheet"
            href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.34520"
          />
          <style
            type="text/css"
            ...
            <div role="main" className="form-all">
              ...
              <ul className="form-section page-section">
                ...
                >
                  ...
                  >
                    {' '}
                    Anything else you want to share (Portfolio, Codechef account etc.)
                    {' '}
                  </label>
                  <div
                    id="cid_12"
